...
task("check-config", "Check config")
  ...
  .setAction(async ({ contractaddress }, { ethers }) => {
    ...
    console.log(
      "MAX_DEV_MINTS= ",
      ethers.BigNumber.from(MAX_DEV_MINTS).toNumber()
    );
    console.log(
      "MAX_MINT_PUBLIC_SALE= ",
      ethers.BigNumber.from(MAX_MINT_PUBLIC_SALE).toNumber()
    );
    console.log(
    ...
    console.log(
      "PUBLIC_SALE_PRICE= ",
      ethers.utils.formatEther(PUBLIC_SALE_PRICE),
      "ETH"
    );
    console.log(
      "WHITELIST_SALE_PRICE= ",
      ethers.utils.formatEther(WHITELIST_SALE_PRICE),
      "ETH"
    );
